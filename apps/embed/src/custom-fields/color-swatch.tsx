...
/**
 * Exemple de champ `custom` embarque dans le bundle Filament: une palette de
 * pastilles de couleur. Branche via `definePageBuilderElement({ customFields })`
 * sous la cle declaree par le field (`component: "color-swatch"`).
 */
